module DatetimepickerGea
  module ViewHelpers
    ...
    def date_time_picker(name_of_form_element,id_of_form_element,default_value="",date_format="dd/MM/yyyy hh:mm:ss",style="display:block;")
      ...
      html = "<div class=\"input-append date datetimepicker_gea\" style=\""+style+"\">"
      html += "<input data-format=\""+date_format+"\" id=\""+id_of_form_element+"\" name=\""+name_of_form_element+"\" value=\""+default_value+"\" type=\"text\"></input>"
